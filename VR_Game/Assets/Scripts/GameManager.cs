...
public class GameManager : MonoBehaviour
{
    ...
    private void SelectMicrophone()
    {
        ...
        if (enableVR && !enableDialogueOptions)
        {
            ...
            // This method selects the Oculus microphone, but the oculus microphone creates a lag spike when starting and ending recording (might need it later)
            //UseOculusMicrophone();
        }
        else
        {
    ...
    private void UseOculusMicrophone()
    {
